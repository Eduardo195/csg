export const BAD_CREDENTIALS = 'registration/BAD_CREDENTIALS';
export const SERVER_ERROR = 'registration/SERVER_ERROR';
export const CLEAR_ERROR = 'registration/CLEAR_ERROR';
